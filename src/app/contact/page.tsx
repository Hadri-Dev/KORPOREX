      ...
      <section className="bg-cream-50 py-20 px-6 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 max-w-xl">
            Whether you&apos;re ready to engage or just exploring your options,
            we&apos;d love to hear about your business and how we might be able
            to help.
          </p>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-xs font-semibold tracking-[0.1em] uppercase text-gray-500 mb-2"
                    >
                      Full Name *
                    </label>
                    <input
          ...
          <div className="md:col-span-2 space-y-8">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-gray-700 hover:text-navy-900"
                    >
            ...
            <div className="bg-cream-50 border border-gray-100 p-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed mb-5">
                Prefer to speak directly? Book a complimentary 30-minute call
                with a Korporex advisor to explore how we can support your
                business.
              </p>
              <a
                href="#"
            ...
            <div className="border-l-4 border-gold-500 pl-5">
              <p className="text-sm text-gray-600 italic leading-relaxed">
                &ldquo;We respond to all enquiries within one business day. For
                urgent matters, please call our office directly.&rdquo;
              </p>
            </div>
          </div>
        </div>

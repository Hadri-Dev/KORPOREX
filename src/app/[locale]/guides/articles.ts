...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Only four Canadian jurisdictions make you obtain a report and hand it in. The rest either search the name themselves or use a different system, which we break down jurisdiction by jurisdiction.",
        parts: [
          "Only four Canadian jurisdictions make you obtain a report and hand it in. The rest either search the name themselves or use a different system, which we ",
          { text: "break down jurisdiction by jurisdiction", href: "/guides/which-provinces-require-nuans" },
          ".",
        ],
      },
      {
        ...
        items: [
          ...
          "Nova Scotia: not required, but supplying your own report can reduce the name-reservation fee.",
          "Saskatchewan, Manitoba, PEI and Yukon: not required. The registry runs the name search as part of the application.",
          "British Columbia, Quebec, Newfoundland and Labrador, Northwest Territories and Nunavut: no NUANS report is submitted. BC and Quebec administer their own name systems.",
  ...
  },
  {
    ...
    content: [
      ...
      { type: "callout", title: "Four jurisdictions", text: "You must obtain and supply a NUANS report for a named corporation federally, in Ontario, in Alberta and in New Brunswick. Everywhere else in Canada, the registry either performs the search itself or uses a different system entirely." },
      ...
      { type: "table", head: ["Jurisdiction", "Do you supply a NUANS report?", "How the name gets checked"], rows: [
        ...
        ["Nova Scotia", "No, but optional", "Search is part of the application; supplying your own report can reduce the reservation fee"],
        ["Saskatchewan", "No", "Name search is included in the application process"],
        ["Manitoba", "No", "Name search is included in the application process"],
        ["Prince Edward Island", "No", "Name search is included in the application process"],
        ["Yukon", "No", "Name search is included in the application process"],
        ["British Columbia", "No", "BC runs its own Name Request system through BC Registries"],
        ["Quebec", "No", "The Registraire des entreprises administers name review under Quebec's own rules"],
        ["Newfoundland and Labrador", "No", "No separate name search required with the application"],
        ["Northwest Territories", "No", "No separate name search required with the application"],
        ["Nunavut", "No", "No separate name search required with the application"],
      ] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "list", items: [
        ...
        "Does the provider cover the jurisdictions you actually file in? Federal, Ontario, Alberta and New Brunswick are the four that require a supplied report, but coverage beyond those matters if your practice is national.",

...
export const articles: Article[] = [
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["NUANS report (if using a named corporation)", "Varies by search house; ordered separately"],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "table", head: ["Élément", "Coût (Ontario)"], rows: [
        ...
        ["Rapport NUANS (pour une société avec un nom)", "Variable selon la maison de recherche ; commandé séparément"],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "table", head: ["Concepto", "Costo (Ontario)"], rows: [
        ...
        ["Informe NUANS (para una sociedad con nombre)", "Varía según la casa de búsqueda; se encarga aparte"],
  ...
  },
  {
    ...
    excerpt:
      "Corporate search pricing has moved sharply against Canadian law firms since 2022. A practical look at how firms actually procure name searches, how to order one without a search-house membership, and how to handle the disbursement.",
    metaTitle: "NUANS Reports for Law Firms and Law Clerks | Korporex",
    metaDescription:
      "A procurement guide to NUANS name searches for Canadian law firms: how firms obtain them, ordering without a search-house account, bulk orders and disbursements.",
    ...
    content: [
      ...
      { type: "paragraph", text: "Name searches are ordinarily billed to the client as a disbursement, which means the amount is visible to the client on the account. Clients who compare the figure on the account against what the same report is advertised for online will occasionally ask about the difference. There is no good answer other than the procurement channel." },
  ...
  },
  {
    ...
    excerpt:
      "Le prix des recherches corporatives a nettement augmenté pour les cabinets canadiens depuis 2022. Voici comment les cabinets s'approvisionnent réellement en recherches de nom, comment en commander une sans adhésion à une maison de recherche, et comment traiter le débours.",
    metaTitle: "Rapports NUANS pour cabinets d'avocats | Korporex",
    metaDescription:
      "Guide d'approvisionnement des recherches de nom NUANS pour les cabinets canadiens : voies d'achat, commande sans compte de maison de recherche, commandes groupées et débours.",
    ...
    content: [
      ...
      { type: "paragraph", text: "Les recherches de nom sont ordinairement facturées au client à titre de débours, ce qui rend le montant visible au relevé. Les clients qui comparent le montant au dossier et ce qu'un rapport équivalent est annoncé en ligne demandent parfois d'où vient l'écart. Il n'y a pas de meilleure réponse que le canal d'approvisionnement." },
      ...
      { type: "paragraph", text: "Korporex effectue des rapports NUANS de recherche préliminaire de nom à un tarif fixe et affiché par nom proposé, sans adhésion, sans minimum et sans forfait obligatoire. Plusieurs noms proposés tiennent sur une même commande au même tarif fixe chacun, l'élément distinctif est saisi dans son propre champ, et les rapports sont retournés par courriel.", parts: ["Korporex effectue des ", { text: "rapports NUANS de recherche préliminaire de nom", href: "/nuans" }, " à un tarif fixe et affiché par nom proposé, sans adhésion, sans minimum et sans forfait obligatoire. Plusieurs noms proposés tiennent sur une même commande au même tarif fixe chacun, l'élément distinctif est saisi dans son propre champ, et les rapports sont retournés par courriel."] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Hay otra razón legítima para comprar un informe que un registro no pidió: la comprobación de riesgo. Si está a punto de construir una marca alrededor de un nombre, hacer la búsqueda para ver los veinte nombres existentes más parecidos en Canadá antes de comprometerse es información barata." },
  ...
  },
  {
    ...
    excerpt:
      "El precio de las búsquedas corporativas se ha vuelto claramente en contra de los despachos canadienses desde 2022. Cómo se abastecen realmente los despachos de búsquedas de nombre, cómo pedirlas sin membresía, y cómo tratar el desembolso.",
    metaTitle: "Informes NUANS para despachos de abogados | Korporex",
    metaDescription:
      "Guía de compra de búsquedas de nombre NUANS para despachos canadienses: vías de compra, pedidos sin cuenta de proveedor, pedidos múltiples y tratamiento del desembolso.",
    ...
    content: [
      ...
      { type: "paragraph", text: "Las búsquedas de nombre se facturan normalmente al cliente como desembolso, lo que hace visible el importe en la minuta. Los clientes que comparan el importe de la minuta con lo que se anuncia por internet por el mismo informe preguntan a veces de dónde sale la diferencia. No hay mejor respuesta que el canal de compra." },
      ...
      { type: "paragraph", text: "Korporex ejecuta informes NUANS de búsqueda preliminar de nombre con una tarifa fija y publicada por nombre propuesto, sin membresía, sin mínimo de cuenta y sin paquete obligatorio. Varios nombres propuestos caben en un mismo pedido a la misma tarifa fija cada uno, el elemento distintivo se captura en su propio campo, y los informes se devuelven por correo electrónico.", parts: ["Korporex ejecuta ", { text: "informes NUANS de búsqueda preliminar de nombre", href: "/nuans" }, " con una tarifa fija y publicada por nombre propuesto, sin membresía, sin mínimo de cuenta y sin paquete obligatorio. Varios nombres propuestos caben en un mismo pedido a la misma tarifa fija cada uno, el elemento distintivo se captura en su propio campo, y los informes se devuelven por correo electrónico."] },

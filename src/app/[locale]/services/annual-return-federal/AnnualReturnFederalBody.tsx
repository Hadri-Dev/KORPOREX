...
const STEP_LABELS = ["Corporation", "Confirm", "Contact", "Billing"];
      ...
      <section className="bg-cream-50 py-8 px-6 border-b border-gray-100">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-sm text-gray-500">
            <span className="font-semibold text-navy-900">${SERVICE.price} CAD</span> + applicable tax + Corporations Canada filing fee. Filed within 2 business days.
          </p>
          <div className="mt-4 p-3 bg-amber-50 border-l-3 border-gold-500 text-xs text-amber-900 leading-relaxed">
            <strong>Statutory deadline:</strong> CBCA s.263 requires the Annual Return (Form 22) to be filed within <strong>60 days</strong> of the anniversary of incorporation. Continued non-filing can lead to dissolution by Corporations Canada.
          </div>
        </div>
      </section>
        ...
        <div className="max-w-xl mx-auto">
          ...
          {step === 1 && (
            <div>
              ...
              <p className="text-gray-500 text-sm mb-8">The federal corporation filing the Annual Return.</p>
              <form onSubmit={(e) => { e.preventDefault(); gotoStep(2); }} className="space-y-5">
                ...
                <Field label="Anniversary date *" error={errors.anniversaryDate?.message} hint="The date of incorporation. The Annual Return is due each year within 60 days after this date.">
                ...
                <Field label="Distributing status *" error={errors.distributingStatus?.message} hint="A distributing corporation is one that has issued securities to the public (publicly traded or reporting issuer).">
                  <select {...register("distributingStatus")} className={sCls}>
                    <option value="non_distributing">Non-distributing (private corporation)</option>
                    <option value="distributing">Distributing (publicly traded / reporting issuer)</option>
                  </select>
                </Field>
                <Field label="Number of shareholders *" error={errors.numberOfShareholders?.message} hint="Approximate count as of the anniversary date.">
          ...
          {step === 2 && (
            <div>
              ...
              <p className="text-gray-500 text-sm mb-6">If anything has changed since the prior return, tell us what so we can update Corporations Canada.</p>
                ...
                <div className="border border-gray-200 rounded-lg p-5 bg-cream-50/30">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-start gap-3 text-sm cursor-pointer">
                      ...
                      <span className="text-gray-800">All information on file with Corporations Canada is <strong>current</strong> — no changes since the prior filing.</span>
                    </label>
                    <label className="flex items-start gap-3 text-sm cursor-pointer">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="border border-gray-200 rounded-lg p-5">
                      <label className="flex items-start gap-3 text-sm cursor-pointer">
                        ...
                        <span className="text-gray-800"><strong>Directors</strong> have changed — provide the current slate below (CBCA s.105(3) Canadian-resident attestation required per director).</span>
                      </label>
                      {directorsChanged && (
                        <div className="mt-4">
                          <CurrentDirectorsArray name="directors" showCanadianResident topError={typeof errors.directors?.message === "string" ? errors.directors.message : undefined} errors={errors.directors} />
                        </div>
                      )}
                    </div>
                ...
                <div className="border border-gray-200 rounded-lg bg-cream-50 p-5 mt-4">
                  ...
                  <div className="space-y-1.5 text-sm">
                    ...
                    <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                      Corporations Canada charges a $12 filing fee (online), billed separately as a pass-through.
                    </p>
                  </div>
                </div>

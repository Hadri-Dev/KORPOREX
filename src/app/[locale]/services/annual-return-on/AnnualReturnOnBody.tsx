...
const STEP_FIELDS: string[][] = [
  ["corporation", "anniversaryDate", "fiscalYearEnd"],
  ["informationCurrent", "registeredOfficeChanged", "newRegisteredOffice", "directorsChanged", "directors", "officersChanged", "officers", "naicsCode", "principalActivity"],
  ["contact"],

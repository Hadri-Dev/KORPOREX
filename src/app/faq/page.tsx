  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "If your application has not yet been filed with the government, you are entitled to a full refund upon request. Once an application has been filed, we are unable to refund government filing fees as these are non-refundable. If an error occurs on our part, we will correct the filing at no additional charge.",
      },
      {
